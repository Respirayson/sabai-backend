...
class VitalsForm(forms.ModelForm):
    visit = forms.ModelChoiceField(
        queryset=Visit.objects.all(), required=False)
    ...
    left_eye_degree = forms.IntegerField(required=False)
    right_eye_degree = forms.IntegerField(required=False)
    ...
    class Meta:
        ...
        fields = ['visit', 'height', 'weight', 'systolic', 'diastolic',
                  ...
                  'heart_rate', 'urine_test', 'hemocue_count', 'blood_glucose',
                  'left_eye_degree', 'right_eye_degree', 'eye_pressure', 'cataracts']
